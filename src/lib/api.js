                    ...
                    if (responseText) {
                        ...
                        try {
                            ...
                            if (errorData.message) {
                                ...
                                errorMessage = errorData.errors.map((err) => err.msg || err.message || JSON.stringify(err)).join(', ');
                            }
