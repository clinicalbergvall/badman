...
export const ChatComponent = ({
  ...
  return (
    <Card className="h-full flex flex-col min-h-[400px] max-h-[100dvh]">
      ...
      <form onSubmit={sendMessage} className="p-3 border-t bg-white shrink-0">
        <div className="flex gap-2 items-end">
          <button 
            type="button"
            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full flex-shrink-0 mb-1"
            title="Attach"
          >
          ...
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full px-4 py-2 border border-gray-200 rounded-[20px] focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent resize-none bg-gray-50 text-sm md:text-base leading-relaxed"
              rows={1}
          ...
          <Button
            ...
            className="p-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full shadow-md hover:shadow-lg transition-all flex-shrink-0 mb-1"
          >
